...
| | |
|---|---|
| ![Groups dashboard](frontend/public/screenshots/groups-dashboard.png) Groups dashboard — balances across every group at a glance | ![Create a group](frontend/public/screenshots/create-group.png) Creating a group |
| ![Group members](frontend/public/screenshots/group-members.png) Adding members by account id or email | ![Add expense with a percentage split](frontend/public/screenshots/add-expense-split.png) Recording an expense with a percentage split |
| ![Group balances](frontend/public/screenshots/group-balances.png) Per-member balances and expense history | ![Settle up](frontend/public/screenshots/settle-up.png) Settling a debt between two members |
| ![After settlement](frontend/public/screenshots/after-settlement.png) Balances updating after a settlement is recorded | ![Notifications](frontend/public/screenshots/notifications.png) Notifications generated by expense/settlement events over Kafka |
